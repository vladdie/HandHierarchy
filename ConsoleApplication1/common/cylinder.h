...
public:
	...
	Cylinder(const float height, const float radiusTop, const float radiusBottom, const vec4& colorTop, const vec4& colorBottom, const int segments) 
	{
	...
	void generateVertices(const float height, const float radiusTop, const float radiusBottom, const vec4& colorTop, const vec4& colorBottom, const int segments)
	{
